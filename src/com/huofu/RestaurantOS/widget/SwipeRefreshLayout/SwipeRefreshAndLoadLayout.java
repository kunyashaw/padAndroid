package com.huofu.RestaurantOS.widget.SwipeRefreshLayout;
...
public class SwipeRefreshAndLoadLayout  extends ViewGroup {
    ...
    public boolean booleanRefresh = true;
    public boolean booleanUpdateTips = true;
    ...
    private final Runnable mCancel = new Runnable() {
        ...
        public void run() {
        		...
        		DeliveryActivity.ivLoadMoreTips.clearAnimation();
        		DeliveryActivity.ivLoadMoreTips.setVisibility(View.INVISIBLE);
        		DeliveryActivity.tvLoadMoreTips.setVisibility(View.INVISIBLE);
    ...
    private void setTriggerPercentage(float percent) {
        ...
        {
	        	if(DeliveryActivity.ivLoadMoreTips.getVisibility() == View.INVISIBLE)
	   	     {
	   	    	 	DeliveryActivity.ivLoadMoreTips.startAnimation(new AnimationUtils().loadAnimation(getContext(), R.anim.rotate_loading));
	   	     }
            ...
            case MotionEvent.ACTION_MOVE:
                if (mDownEvent != null && !mReturningToStart) 
                {
                    ...
                    if (yDiff > mTouchSlop) 
                    {
                        ...
                        if (yDiff > (mDistanceToTriggerSync+5)) 
                        {
                            // User movement passed distance; trigger a refresh
                    	    	 		
                        	
                        		DeliveryActivity.tvLoadMoreTips.setText("松开以加载更多");
                    	    	 	booleanUpdateTips = true;
                        ...
                        } else 
                        {
                            // Just track the user's movement
                        		...
                        		mDistanceToTriggerSync = mDistanceToTriggerSync-5;
                            ...
                            {
                                // If the user puts the view back at the top, we don't need to. This shouldn't be considered cancelling the gesture as the user can restart from the top.
                                removeCallbacks(mCancel);
                            }
                            else 
                            {
                               updatePositionTimeout();
                               DeliveryActivity.ivLoadMoreTips.setVisibility(View.VISIBLE);
                               DeliveryActivity.ivLoadMoreTips.startAnimation(new AnimationUtils().loadAnimation(getContext(),R.anim.rotate_loading));
