...
import com.huofu.RestaurantOS.adapter.ListViewNotificationAdapter;
...
public class SimpleSideDrawer extends FrameLayout {
    ...
    public final LinearLayout mRightBehindBase;
    private final View mOverlay;

    public static ListViewNotificationAdapter adapter;
    public static RelativeLayout rlNotifactions ;

    public boolean flagRightOpen = false;
    public boolean flagLeftOpen = false;
    ...
    public SimpleSideDrawer(Activity act, Interpolator ip, int duration) {
        ...
        adapter = new ListViewNotificationAdapter(getContext());
        rlNotifactions = new RelativeLayout(getContext());
        ...
        mBehindView.setBackgroundResource(R.drawable.launchpad_bg);//kunyashaw
        ...
        //mOverlay.setAlpha(0.3f);
        //mOverlay.setBackgroundColor(Color.YELLOW);
        ...
        rlNotifactions.setLayoutParams(lp);

        View grid = inflater.inflate(R.layout.listview_notification,null);
        ...
        rlNotifactions.addView(grid,lpTv);
    ...
    public void hideAboveView()
    {
        mLeftBehindViewWidth = mLeftBehindBase.getMeasuredWidth();

        Animation ani = (new AnimationUtils().loadAnimation(MainApplication.getContext(), R.anim.slide_right_out));
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mLeftBehindViewWidth = 200;//mLeftBehindBase.getMeasuredWidth();
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if (isLeftSideOpened()) {
            CommonUtils.LogWuwei("SimpleSideDrawer", "left  onTouchEvent");
            return mLeftDragAction.onTouchEvent(ev);
        } else if (isRightSideOpened()) {
            CommonUtils.LogWuwei("SimpleSideDrawer", "right  onTouchEvent");
