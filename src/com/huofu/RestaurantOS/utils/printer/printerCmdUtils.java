package com.huofu.RestaurantOS.utils.printer;
...
public class printerCmdUtils {
	...
	public static String tag = "printerCmdUtils";
...
//------------------------字节流数组拼接-----------------------------
    ...
    public static byte[] byteMerger(byte[] byte_1, byte[] byte_2){  
        ...
        {
        		CommonUtils.LogWuwei(tag, "byteMerger in printerCmdUtils failed caused by null exception");
        }
        return null;
    }  
