...
public abstract class NanoHTTPD {
    ...
    public Response serve(String uri, Method method, Map<String, String> headers, Map<String, String> parms,
        ...
        return new Response(Response.Status.WUWEI_CONNECT_TEST, MIME_PLAINTEXT, "五味测试");
		//return new Response(Response.Status.NOT_FOUND, MIME_PLAINTEXT, "zzl Not Found");
    }
