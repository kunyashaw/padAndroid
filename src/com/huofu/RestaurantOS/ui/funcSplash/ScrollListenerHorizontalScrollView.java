...
public class ScrollListenerHorizontalScrollView extends HorizontalScrollView{
    ...
    enum ScrollType{IDLE,TOUCH_SCROLL,FLING};//滚动状态   IDLE 滚动停止  TOUCH_SCROLL 手指拖动滚动         FLING滚动
    private int currentX = -9999999;    //记录当前滚动的距离
    private ScrollType scrollType = ScrollType.IDLE;    //当前滚动状态
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			CommonUtils.LogWuwei("", "movingX is "+getScrollX()+"currentX is "+currentX);
			break;
