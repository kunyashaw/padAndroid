...
import com.ShanFuBao.SmartCall.R;
import com.ShanFuBao.SmartCall.utils.CommonUtils;
...
public class NiftyDialogBuilder extends Dialog implements DialogInterface {
    ...
    private final String tag = "NiftyDialogBuilder";
    ...
    public static int nowChooseButton = -1;

    public static NiftyDialogBuilder instance;
    ...
    public NiftyDialogBuilder onkeyAnswer()
    {
    		setOnKeyListener(new OnKeyListener() {
				...
				public boolean onKey(DialogInterface dialog, int keyCode, KeyEvent event) {
			    	...
			    	{
			    		nowChooseButton = 0;
			    		mButton2.setBackgroundColor(0x77ad2d12);
			    		mButton1.setBackgroundColor(0xffad2d12);
			    	}
			    	else if(keyCode == KeyEvent.KEYCODE_DPAD_RIGHT)
			    	{
			    		nowChooseButton = 1;
			    		mButton1.setBackgroundColor(0x77ad2d12);
			    		mButton2.setBackgroundColor(0xffad2d12);
			    	}
			    	else if(keyCode == KeyEvent.KEYCODE_ENTER)
			    	{
			    		if(nowChooseButton == 0)
			    		{
			    			CommonUtils.LogWuwei(tag, "button1 按下");
			    			mButton1.performClick();
			    		}
			    		else if(nowChooseButton == 1)
			    		{
			    			CommonUtils.LogWuwei(tag, "button2 按下");
			    			mButton2.performClick();
			    		}
			    	}
			    	
			    	CommonUtils.LogWuwei(tag,"nowChooseButton is "+nowChooseButton+" keyCode is "+keyCode);
    ...
    public void show() {
        ...
        CommonUtils.LogWuwei("nifityDialogBuilder befroe show", "nifityDialogBuilder show line:283");
        super.show();
        CommonUtils.LogWuwei("nifityDialogBuilder after show", "nifityDialogBuilder show line:285");
    }
